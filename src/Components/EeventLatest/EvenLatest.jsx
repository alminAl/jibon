...
const EvenLatest = () => {
    ...
    return (
        ...
        <div style={{ padding: '15px', marginTop: '100px', }} className='row gx-5'>
...

            {
                eventList.map((item) => {
                    ...
                    return (
                        ...
                        <div key={item.id} className=" col-lg-4 col-md-4 col-sm-6 col-xs-12 gx-2 ">
                            <div className='event-card'>
                                <div className="card-inneer-container ">
                                    ...
                                    <div className="event-info-container"><h6>{item.title}   </h6>
                                        <span><span style={{ verticalAlign: "baseline" }}><FontAwesomeIcon icon={faLocationCrosshairs} /> Chittagong</span> <span style={{ verticalAlign: "baseline" }}><FontAwesomeIcon icon={faClock} /> 11 am</span></span>
                                    </div>
